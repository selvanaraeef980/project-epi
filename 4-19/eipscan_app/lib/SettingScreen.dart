            ...
            ElevatedButton(
              ...
              style: ButtonStyle(
                ...
                minimumSize: MaterialStateProperty.all<Size>(
                  Size(double.infinity, 40), // تعديل حجم الزر
                ),
                padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
                  EdgeInsets.symmetric(vertical: 10, horizontal: 16), // تعديل حجم الهامش
                ),
              ),
              child: Row(
                ...
                children: [
                  Text(
                    'Account Settings',
                    style: TextStyle(fontSize: 18, color: Colors.white), // تصغير حجم النص
                  ),
